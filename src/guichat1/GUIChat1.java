 ...
 */
public class GUIChat1 extends JFrame {
    ...
    * application; it just creates a GUIChat11 window and makes it visible.
    */
   public static void main(String[] args) {
      GUIChat1 window = new GUIChat1();
   ...
   public GUIChat1(String title) {
     ...
     // messageInput.setFont(Font.createFont(12, fontFile));
         ...
         if (source == newButton) {
            ...
            if (connection == null || 
               ...
               try {
                  ...
                  JOptionPane.showMessageDialog(GUIChat1.this, 
